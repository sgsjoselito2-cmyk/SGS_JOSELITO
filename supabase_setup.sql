...
-- Plan de Acción Estratégico TOP 60
CREATE TABLE IF NOT EXISTS plan_accion_top60 (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  numero INT,
  seccion TEXT,
  problema TEXT,
...
ALTER TABLE plan_accion_top60 DISABLE ROW LEVEL SECURITY;
GRANT ALL ON TABLE plan_accion_top60 TO anon;
GRANT ALL ON TABLE plan_accion_top60 TO authenticated;
